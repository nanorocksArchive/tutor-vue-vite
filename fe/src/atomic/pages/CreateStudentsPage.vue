...
import CreateStudentsTemplate from "../templates/CreateStudentsTemplate.vue";

export default {
  components: { Footer, AuthMiddleware, TemplateLayout, AdminHeader, CreateStudentsTemplate },
};
</script>